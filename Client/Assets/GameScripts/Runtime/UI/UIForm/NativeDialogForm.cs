...
namespace FieldTale
{
    public class NativeDialogForm : MonoBehaviour
    {
        ...
        private void RefreshConfirmText(string confirmText)
        {
            ...
            {
                confirmText = FrameworkRoot.Localization.GetString("Dialog.ConfirmButton");
            }
        ...
        private void RefreshCancelText(string cancelText)
        {
            ...
            {
                cancelText = FrameworkRoot.Localization.GetString("Dialog.CancelButton");
            }
        ...
        private void RefreshOtherText(string otherText)
        {
            ...
            {
                otherText = FrameworkRoot.Localization.GetString("Dialog.OtherButton");
            }
