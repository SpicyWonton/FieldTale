...
namespace FieldTale
{
    public class ProcedureVerifyResources : ProcedureBase
    {
        ...
        protected override void OnEnter(IFsm<IProcedureManager> procedureOwner)
        {
            ...
            FrameworkRoot.Event.Subscribe(ResourceVerifyStartEventArgs.EventId, OnResourceVerifyStart);
            FrameworkRoot.Event.Subscribe(ResourceVerifySuccessEventArgs.EventId, OnResourceVerifySuccess);
            FrameworkRoot.Event.Subscribe(ResourceVerifyFailureEventArgs.EventId, OnResourceVerifyFailure);

            m_VerifyResourcesComplete = false;
            FrameworkRoot.Resource.VerifyResources(OnVerifyResourcesComplete);
        }
        ...
        protected override void OnLeave(IFsm<IProcedureManager> procedureOwner, bool isShutdown)
        {
            ...
            FrameworkRoot.Event.Unsubscribe(ResourceVerifyStartEventArgs.EventId, OnResourceVerifyStart);
            FrameworkRoot.Event.Unsubscribe(ResourceVerifySuccessEventArgs.EventId, OnResourceVerifySuccess);
            FrameworkRoot.Event.Unsubscribe(ResourceVerifyFailureEventArgs.EventId, OnResourceVerifyFailure);
        }
