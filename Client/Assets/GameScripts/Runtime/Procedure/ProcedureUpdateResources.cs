...
namespace FieldTale
{
    public class ProcedureUpdateResources : ProcedureBase
    {
        ...
        protected override void OnEnter(IFsm<IProcedureManager> procedureOwner)
        {
            ...
            FrameworkRoot.Event.Subscribe(ResourceUpdateStartEventArgs.EventId, OnResourceUpdateStart);
            FrameworkRoot.Event.Subscribe(ResourceUpdateChangedEventArgs.EventId, OnResourceUpdateChanged);
            FrameworkRoot.Event.Subscribe(ResourceUpdateSuccessEventArgs.EventId, OnResourceUpdateSuccess);
            FrameworkRoot.Event.Subscribe(ResourceUpdateFailureEventArgs.EventId, OnResourceUpdateFailure);
            ...
            if (Application.internetReachability == NetworkReachability.ReachableViaCarrierDataNetwork)
            {
                ...
                {
                    Mode = 2,
                    Title = FrameworkRoot.Localization.GetString("UpdateResourceViaCarrierDataNetwork.Title"),
                    Message = FrameworkRoot.Localization.GetString("UpdateResourceViaCarrierDataNetwork.Message"),
                    ConfirmText = FrameworkRoot.Localization.GetString("UpdateResourceViaCarrierDataNetwork.UpdateButton"),
                    OnClickConfirm = StartUpdateResources,
                    CancelText = FrameworkRoot.Localization.GetString("UpdateResourceViaCarrierDataNetwork.QuitButton"),
        ...
        protected override void OnLeave(IFsm<IProcedureManager> procedureOwner, bool isShutdown)
        {
            ...
            FrameworkRoot.Event.Unsubscribe(ResourceUpdateStartEventArgs.EventId, OnResourceUpdateStart);
            FrameworkRoot.Event.Unsubscribe(ResourceUpdateChangedEventArgs.EventId, OnResourceUpdateChanged);
            FrameworkRoot.Event.Unsubscribe(ResourceUpdateSuccessEventArgs.EventId, OnResourceUpdateSuccess);
            FrameworkRoot.Event.Unsubscribe(ResourceUpdateFailureEventArgs.EventId, OnResourceUpdateFailure);
        ...
        private void StartUpdateResources(object userData)
        {
            ...
            FrameworkRoot.Resource.UpdateResources(OnUpdateResourcesComplete);
        }
        ...
        private void RefreshProgress()
        {
            ...
            string descriptionText = FrameworkRoot.Localization.GetString("UpdateResource.Tips", m_UpdateSuccessCount.ToString(), m_UpdateCount.ToString(), GetByteLengthString(currentTotalUpdateLength), GetByteLengthString(m_UpdateTotalCompressedLength), progressTotal.ToString("F2"), GetByteLengthString((int)FrameworkRoot.Download.CurrentSpeed));
