...
namespace FieldTale
{
    public class ProcedureUpdateVersion : ProcedureBase
    {
        ...
        protected override void OnEnter(IFsm<IProcedureManager> procedureOwner)
        {
            ...
            FrameworkRoot.Resource.UpdateVersionList(procedureOwner.GetData<VarInt32>("VersionListLength"), procedureOwner.GetData<VarInt32>("VersionListHashCode"), procedureOwner.GetData<VarInt32>("VersionListCompressedLength"), procedureOwner.GetData<VarInt32>("VersionListCompressedHashCode"), m_UpdateVersionListCallbacks);
