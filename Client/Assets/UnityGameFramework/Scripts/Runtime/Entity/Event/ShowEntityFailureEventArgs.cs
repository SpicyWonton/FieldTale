...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class ShowEntityFailureEventArgs : GameEventArgs
    {
        ...
        internal static ShowEntityFailureEventArgs Create(int entityId, Type entityLogicType, string assetName, string groupName, string errorMessage, object userData)
        {
