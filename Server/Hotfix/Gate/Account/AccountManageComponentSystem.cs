...
{
    public static bool Add(this AccountManageComponent self, string accountName, string password, out Account account)
    {
        ...
        account = AccountFactory.Create(self.Scene, accountName, password);
