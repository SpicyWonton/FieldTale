...
public static class AccountManageHelper
{
    ...
    public static bool Add(Scene scene, string accountName, string password, out Account account)
    {
        var accountManageComponent = scene.GetComponent<AccountManageComponent>();
        if (accountManageComponent != null)
        {
            return accountManageComponent.Add(accountName, password, out account);
        }
